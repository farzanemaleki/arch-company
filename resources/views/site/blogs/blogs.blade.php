      ...
      <div class="container">
        <div class="filter-content-3">
          <ul class="filter js-filter">
            <li class="active"><a href="news-grid.html#" data-filter="*">All</a></li>
            <li><a href="news-grid.html#" data-filter=".inspiration">Inspiration</a></li>
            <li><a href="news-grid.html#" data-filter=".architecture-inteior">Architecture & Inteior</a></li>
            <li><a href="news-grid.html#" data-filter=".decoration">Decoration</a></li>
            <li><a href="news-grid.html#" data-filter=".plants">Plants</a></li>
          </ul>
        </div>
          ...
          <div class="grid-item inspiration js-isotope-item js-grid-item">
            <div class="news-item">
              ...
              <div class="news-hover">
                ...
                <a class="read-more" href="news-grid.html#">Continue</a>
              </div>
            </div>
          </div>
          <div class="grid-item inspiration js-isotope-item js-grid-item">
